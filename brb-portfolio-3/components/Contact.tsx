            ...
            <div className='grid grid-cols-2 justify-between h-full'>
                ...
                <div className='w-[1/2] h-full flex flex-col gap-y-6'>
                    ...
                    <div className='flex space-x-3 justify-end'>
                        <ContactCard
                            website='LinkedIn'
                            link='https://www.linkedin.com/in/brandenbasche/'
                            icon={<LinkedInIcon />}
                        />
                        <ContactCard
                            website='GitHub'
                            link='https://github.com/brandenrbasche'
                            icon={<GitHubIcon />}
                        />
                        <ContactCard
                            website='Email'
                            link='mailto:brandenbasche@gmail.com'
                            icon={<EmailIcon />}
                        />
                    </div>
                </div>
...
const LinkedInIcon = () => {
    return (
        <svg className='group-hover:text-[#0072b1] transition ease-in-out' xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 464 480">
...
const GitHubIcon = () => {
    return (
        <svg className='group-hover:text-[#e37222] transition ease-in-out' xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 56 56">
            <path fill="currentColor"
...
const EmailIcon = () => {
    return (
        <svg className='group-hover:text-[#c71610] transition ease-in-out' xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 16 16">
            <path fill="currentColor"
