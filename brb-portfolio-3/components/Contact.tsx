    ...
    return (
        <section className='w-full p-5'>
            <div className='h-auto'>
                ...
                <h1 className={twMerge('text-3xl text-center mb-2')}>Thanks for stopping by!</h1>
                <p className='text-sm font-light text-center'>Have any questions? Reach out. <span className='italic'>(I reply fast)</span></p>
                <div className='w-full flex space-x-6 justify-center my-5'>
                    <ContactCard
                        website='LinkedIn'
